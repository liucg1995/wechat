...
//                break;
    ...
    public function sendText(Request $request)
    {
        ...
        if ($sendResult->errcode == 0) {
            ...
            $massLog->result = '提交成功';
            $massLog->save();
            return redirect('/massage/index')->with('mgssages', array(0 => '提交成功'));
        } else {
            $massLog = new MassLog();
            $massLog->msgId = $msgId;
            $massLog->receiver = $receiver;
            ...
            $massLog->result = '提交失败';
            $massLog->save();
            return redirect('/massage/index')->with('mgssages', array(0 => '提交失败'));
        }
...
//            }
            ...
            if ($sendResult->errcode == 0) {
                ...
                $massLog->result = '提交成功';
                $massLog->save();
                return redirect('message/test')->with('mgssages', array(0 => '提交成功'));
            } else {
                $massLog = new MassLog();
                $massLog->number = 1;
                $massLog->msgId = $msgId;
                ...
                $massLog->result = '提交失败';
                $massLog->save();
                return redirect('message/test')->with('mgssages', array(0 => '提交失败'));
            }
        }
