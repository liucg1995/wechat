                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <span class="btn btn-success fileinput-button btn-xs">
                                        ...
                                        <input class="coverUpload" type="file" name="files[]" data-url="/media/upload">
                                    </span>
                                                ...
                                                <form method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="mixedTitle"
                                                               name="title">
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="show_cover_in_text"
                                                                   checked="checked"> 在内容中显示题图
                                                        </label>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="mixedAuthor">作者（选填）</label>
                                                        <input type="text" class="form-control" id="mixedAuthor"
                                                               name="author">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>摘要</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="disabledSelect">选择要加入的链接</label>
                                                        <select id="disabledSelect" class="form-control" name="link">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5" style="width:350px;">
                                            <div class="panel panel-default" id="mixed_multi_preview">
                                                ...
                                                <div class="panel-footer text-center"><a href="#add"
                                                                                         class="addnew">增加一条</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <span class="btn btn-success fileinput-button btn-xs">
                                                <span>选择题图</span>
                                                <!-- The file input field used as target for the file upload widget -->
                                                <input class="coverUpload" type="file" name="files[]"
                                                       data-url="/media/upload">
                                            </span>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <input type="hidden" name="media_delete" class="media_delete"
                                                               value="">
                                                        <div class="form-group">
                                                            <label>标题</label>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-5">
                                        ...
                                        <span class="btn btn-success fileinput-button btn-xs">
                                            <span>选择文件</span>
                                            <!-- The file input field used as target for the file upload widget -->
                                            <input id="imageUpload" type="file" name="files[]" data-url="/media/upload">
                                        </span>
                        ...
                        <div class="tab-pane" id="audio">
                            <div class="panel panel-default">
                                ...
                                <span class="btn btn-success fileinput-button btn-xs">
                                    <span>选择文件</span>
                                    <!-- The file input field used as target for the file upload widget -->
                                    <input id="audioUpload" type="file" name="files[]" data-url="/media/upload">
                                </span>
                    ...
                    if (m.media_type == 2) {
                        ...
                        $.each(b_data, function (key, val) {
                            if (val != undefined) {
                                ...
                                html.push('<li class="list-group-item"><a href="#' + bid + '" class="action-modify-multi" data-bid="' + bid + '">修改</a> <a href="/media/delete?id=' + bid + '&mt=' + m.media_type + '" class="action-del">删除</a></li>');
...
//                                idOrder=a.reverse();
                        ...
                        $.each(data, function (index, obj) {
                            ...
                            html.push('<a href="/media/delete?id=' + obj.id + '&mt=' + m.media_type + '" class="action-del">删除</a>');
                            html.push('</td>');
                            html.push('</tr>');
                        });
                        html.push('</table>');
